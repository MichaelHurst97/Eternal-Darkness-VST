...
public:
        ...
        const float rotaryStartAngle, const float rotaryEndAngle, juce::Slider& slider) override
    {
        ...
        auto dropShadow = juce::DropShadow(juce::Colours::darkgrey, 7, juce::Point(0, 0));
        ...
        juce::String text;
        if (labelType == "typeNone") {
            text = labelText;
        }
        else if (labelType == "typeSimple") {
            text = labelText + juce::newLine + juce::String((int)value) + " %";
        }
        else if (labelType == "typeSimpleHalved") {
            text = labelText + juce::newLine + juce::String((int)value * 2) + " %";
        }
        else if (labelType == "typeReverbSize") {
            text = labelText + juce::newLine + "SIZE";
        }
        else if (labelType == "typePercent") {
            text = labelText + juce::newLine + "%";
        }
        else if (labelType == "typeSemitones") {
            text = labelText + juce::newLine + juce::String(value / 100) + " ST";
        }
        else if (labelType == "typeFilter") {
